...
public class SubCommandGetColour extends SubCommand {
    
    @Override
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (sender.getCommandSenderEntity() instanceof EntityPlayerMP) PacketHandler.NETWORK_INSTANCE.sendTo(new CommandExecuteMessage((byte)0),
